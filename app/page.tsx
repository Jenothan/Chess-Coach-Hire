                ...
                <div className="grid md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><Link href="/student/coaches" className="hover:text-accent">Find Coaches</Link></li>
                            <li><Link href="/register?role=student" className="hover:text-accent">Sign Up</Link></li>
                            <li><Link href="/help" className="hover:text-accent">How It Works</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-semibold mb-4">For Coaches</h4>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                            <li><Link href="/register?role=coach" className="hover:text-accent">Become a Coach</Link></li>
                            <li><Link href="/help" className="hover:text-accent">Coach Resources</Link></li>
                        </ul>
                    </div>
                    <div>
