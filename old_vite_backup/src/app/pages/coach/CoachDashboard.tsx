...
import { Calendar, DollarSign, Users, Clock, Star, TrendingUp, CheckCircle, XCircle } from 'lucide-react';
...
const recentStudents = [
  { id: 1, name: 'David Lee', lessons: 12, rating: 4.8, lastLesson: '2026-02-12' },
  { id: 2, name: 'Emma Wilson', lessons: 8, rating: 4.9, lastLesson: '2026-02-11' },
  { id: 3, name: 'Michael Brown', lessons: 15, rating: 5.0, lastLesson: '2026-02-13' },
  { id: 4, name: 'Sophie Chen', lessons: 6, rating: 4.7, lastLesson: '2026-02-10' },
];
    ...
    <div className="space-y-8">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <h3>Your Students</h3>
            <p className="text-sm text-muted-foreground">Recent active students</p>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {recentStudents.map((student) => (
                <div key={student.id} className="flex items-center justify-between p-3 border border-border rounded-lg hover:bg-accent/5 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">{student.lessons} lessons</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <p className="text-xs text-muted-foreground">{student.lastLesson}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="p-4 bg-accent/5 rounded-lg">
                ...
                <p className="text-2xl font-bold">28.5h</p>
                <p className="text-xs text-green-600 mt-1">+3.5h from last week</p>
              </div>
              ...
              <div className="p-4 bg-accent/5 rounded-lg">
                ...
                <p className="text-xs text-green-600 mt-1">New enrollments</p>
              </div>
